...
namespace WebApplication1.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Categorie,Image,Price")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Categorie,Image,Price")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
